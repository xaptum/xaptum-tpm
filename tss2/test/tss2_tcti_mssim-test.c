...
void initialize(struct test_context *ctx)
{
    ...
    TEST_ASSERT(NULL != ctx->tcti_ctx);

    init_ret = Tss2_Tcti_Mssim_Init(ctx->tcti_ctx, &ctx_size, mssim_conf_g);
    TEST_ASSERT(TSS2_RC_SUCCESS == init_ret);
}
...
void init_test()
{
    printf("In tss2_tcti_mssim-test::init_test...\n");
...
{
    printf("In tss2_tcti_mssim-test::getpollhandles_test...\n");
...
{
    printf("In tss2_tcti_mssim-test::setlocality_test...\n");
...
void startup_test()
{
    printf("In tss2_tcti_mssim-test::startup_test...\n");
...
void getrandom_test()
{
    printf("In tss2_tcti_mssim-test::getrandom_test...\n");
...
int main()
{
    printf("Not running tss2_tcti_mssim-test\n");
}
