...
int createprimary(struct test_context *ctx)
{
    ...
    in_public.publicArea.parameters.eccDetail.scheme.scheme = TPM_ALG_ECDSA;
    in_public.publicArea.parameters.eccDetail.scheme.details.ecdsa.hashAlg = TPM_ALG_SHA256;
